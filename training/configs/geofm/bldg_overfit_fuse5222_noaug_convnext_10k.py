...
NON-RGB body (adapter_fusion_lite_hrnet_convnext_token_fusion) per user request — same trunk as the
...
config = dict(
    model=dict(
        ...
        params=dict(
            model_type="adapter_fusion_lite_hrnet_convnext_token_fusion",   # NON-RGB
            in_channels=192,
